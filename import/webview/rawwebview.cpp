...
public:
    ...
    quint32 createView(const quint32 &parentId, const uintptr_t &parentBrowsingContext = 0) override;
...
quint32 ViewCreator::createView(const quint32 &parentId, const uintptr_t &)
{
